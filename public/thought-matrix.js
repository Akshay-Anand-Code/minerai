...
const initialMessages = [
    "Dynamic visualizations that empower decision-making...",
    "Transform complex data into intuitive visual stories with AI-enhanced, interactive dashboards.",
    "Discover hidden patterns in your data through cognitive computing and self-learning algorithms",
    "------------------------------------------"
];
